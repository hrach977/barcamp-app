...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
               // finish();
                final List<DummyContent.Workshop> events = new ArrayList<>();
                    ...
                    public void onResponse(Call<List<ScheduleElement>> call, retrofit2.Response<List<ScheduleElement>> response) {
                        if (response.isSuccessful()) {
                            ...
                            for(ScheduleElement scheduleElement: response.body()) {
                                ...
                                events.add(new DummyContent.Workshop(count+"", speaker, scheduleElement.getEn().getTopic()));
                                DummyContent.DummyItem item = new DummyContent.DummyItem(String.valueOf(count), "Workshop " + count, "details", speaker, scheduleElement.getEn().getTopic(), start, finish, scheduleElement.getRoom());
                                DummyContent.ITEMS.add(item);
                                DummyContent.ITEM_MAP.put(String.valueOf(count), item);
                            ...
                            System.out.println("*******THE WORKSHOPS**********");
                            System.out.println("ITEMS IS: " + DummyContent.ITEMS);
                            System.out.println("ITEM_MAP IS: " + DummyContent.ITEM_MAP);
                            showWorkshops();
                        }
                    }
        ...
        public void showWorkshops(){
            startActivity(new Intent(LoginActivity.this, WorkshopListActivity.class));
        }
    }
}
